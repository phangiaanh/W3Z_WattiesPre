...
def vith(cfg=None, img_size=(256, 256), patch_size=16, embed_dim=1280, depth=32, 
         num_heads=16, ratio=1, use_checkpoint=False, mlp_ratio=4, qkv_bias=True, 
         drop_path_rate=0.55, use_cls=True):
    """Create ViT-H backbone."""
    if cfg is not None:
        ...
        return ViT(
            ...
            drop_path_rate=cfg.get('drop_path_rate', 0.55),
